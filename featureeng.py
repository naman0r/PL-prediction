...
df['winner'] = df['winner'] = np.where(df.home_score > df.away_score, 'HOME_TEAM', np.where(df.away_score > df.home_score, 'AWAY_TEAM', 'DRAW'))
...
# --- Add this line to save the DataFrame ---
# Define the path and filename for your output CSV
output_filepath = r"C:\Users\jfbaa\PycharmProjects\ds2500\2500 project\processed_matches.csv" 
# Save the DataFrame to CSV
df.to_csv(output_filepath, index=False)
print(f"DataFrame saved successfully to: {output_filepath}")
